...
def extractColumn(df_votes, content, column):
    particular_vote_bool = df_votes[column].str.contains(content)
    df_particular_vote = df_votes[particular_vote_bool.fillna(False)]
    # df_sorted = df_particular_vote.sort_values("birthDate")
    print(df_particular_vote)
...
if __name__ == "__main__":
    ...
    for age in df_age:
        df_age[age].to_csv(os.path.join('AnalyseAge_results', "df_vote_age_"+age+".csv"))

    # # extractColumn(dfv, "CSSS", "Commission")
